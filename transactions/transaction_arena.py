...
class Transactions:
    ...
    def add_this_trans(self):
        ...
        print(self.nonce)
        x = requests.get("http://localhost/Waziri_Coin/_transrecorder.php?\
            private_key={}&\
            sender_address={}&\
            receiver_address={}&\
            previous_hash={}&\
    ...
    def get_the_previous_keys(self):
        x = requests.get("http://localhost/Waziri_Coin/get_previous_hash.php?echo=true")
        x = x.json()
        the_previous = ""
        try:
            """ if (x["status"] == "false" ):
        ...
        #print(the_previous)
        """ 
        url = "http://localhost/Waziri_Coin/get_previous_hash.php"
